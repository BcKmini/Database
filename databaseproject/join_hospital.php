...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO hospital_tbl (
        h_distingush, h_name, h_sex, h_id, h_pw, h_idnumber, h_mobile, h_major, h_file, h_workingname, h_workingaddress, h_approved
    ) VALUES (
        '$h_distingush', '$h_name', '$h_sex', '$h_id', '$h_pw', '$h_idnumber', '$h_mobile', '$h_major',
        '$h_file', '$h_workingname', '$h_workingaddress', FALSE
    )";    
