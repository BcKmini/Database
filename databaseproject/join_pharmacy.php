...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $required_fields = [
        ...
        '주민등록번호를 입력해주세요' => $ph_idnumber,
         '면허증을 등록해주세요' => isset($_FILES['h_file']) && $_FILES['h_file']['error'] == 0 ? $_FILES['h_file']['name'] : ''
    ];
    ...
    $sql = "INSERT INTO pharmacy_tbl (
        ph_name, ph_sex, ph_id, ph_pw, ph_idnumber, ph_mobile, ph_file, ph_workingname, ph_workingaddress, ph_approved
    ) VALUES (
       '$ph_name', '$ph_sex', '$ph_id', '$ph_pw', '$ph_idnumber', '$ph_mobile', 
        '$h_file', '$ph_workingname', '$ph_workingaddress', FALSE
    )";
